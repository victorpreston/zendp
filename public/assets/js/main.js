jQuery(function ($) {
	...
	$(".newsletter-form").ajaxChimp({
		url: "https://zendp.com.us20.list-manage.com/subscribe/post?u=60e1ffe2e8a68ce1204cd39a5&amp;id=42d6d188d9", // Your url MailChimp
...
//     localStorage.setItem('zendp_theme', themeName);
//     document.documentElement.className = themeName;
// }
// // function to toggle between light and dark theme
// function toggleTheme() {
//     if (localStorage.getItem('zendp_theme') === 'theme-dark') {
